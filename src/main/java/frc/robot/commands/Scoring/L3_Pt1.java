...
public class L3_Pt1 extends SequentialCommandGroup {

  public L3_Pt1(Elevator elevator, CoralHold coralHold, CoralPivot coralPivot, AlgaePivot algaePivot) {
  addCommands(
    Commands.parallel(
    ...
    new PIDCoralPivot(coralPivot, Constants.CoralPivot.ENC_REVS_LEVEL3),//.withTimeout(0.9)
      Commands.sequence(
       new WaitCommand(0.1), //wait for elevator to go up
